...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--anno_pack_path',  help='Path to package containing annotation json files',default="E:/papercode/VNL_Monocular_Depth_Prediction-master/datasets/NYUDV2/annotations")
        # ----------------added end----------------------
        ...
        parser.add_argument('--load_ckpt', default="",help='Checkpoint path to load')
        # parser.add_argument('--resume', action='store_true', help='Resume to train')
        parser.add_argument('--resume', default=False, help='Resume to train',type=bool)
